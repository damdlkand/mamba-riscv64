...
if [ "libgfortran" != "libgfortran" ]; then
...
if [ "libquadmath" != "libgfortran" ]; then
...
cat > "$PREFIX/etc/conda/activate.d/libgfortran_activate.sh" <<'ACT'
...
ACT
cat > "$PREFIX/etc/conda/deactivate.d/libgfortran_deactivate.sh" <<'DEACT'
